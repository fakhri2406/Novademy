    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursePackages", x => new { x.CoursesId, x.PackagesId });
                    table.ForeignKey(
                        name: "FK_CoursePackages_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoursePackages_Packages_PackagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursePackages_PackagesId",
